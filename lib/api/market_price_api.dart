...
class MarketPriceApiService {
  final String baseUrls = 'https://teravaanii-hggpe8btfsbedfdx.canadacentral-01.azurewebsites.net/api'; // replace IP
  final String baseUrl = 'https://teravaanii-hggpe8btfsbedfdx.canadacentral-01.azurewebsites.net/api/market-prices'; // replace IP
